src/main/java/com/ipiecoles/java/java350/model/Employe.java
...
public class Employe {
    ...
    public Integer getNbRtt(LocalDate d){
        ...
        int nbJoursFeries = (int) Entreprise.joursFeries(d).stream()
                ...
                .count();
        return (int) Math.ceil((nbJoursAnnee - Entreprise.NB_JOURS_MAX_FORFAIT - nbWeekends - Entreprise.NB_CONGES_BASE - nbJoursFeries) * tempsPartiel);
    }
    ...
    public Double getTempsPartiel() { return tempsPartiel; }
    public void setTempsPartiel(Double tempsPartiel) { this.tempsPartiel = tempsPartiel; }
